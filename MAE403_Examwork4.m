...
dz=[z(1) z(250) z(500) z(750) z(1001)]; % x y z position of cm on trajectory
 ...
 figure(1), clf
 plot3(x ,y ,z ,':','Color',[0.5 0.5 0.5],'LineWidth',1.2), hold
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 hold('on')
...
plot3([v211(1)+dx(2) v212(1)+dx(2)],[v211(2)+dy(2) v212(2)+dy(2)],[v211(3)+dz(2) v212(3)+dz(2)],'-k');
plot3([v221(1)+dx(2) v222(1)+dx(2)],[v221(2)+dy(2) v222(2)+dy(2)],[v221(3)+dz(2) v222(3)+dz(2)],'-k');
plot3([v231(1)+dx(2) v232(1)+dx(2)],[v231(2)+dy(2) v232(2)+dy(2)],[v231(3)+dz(2) v232(3)+dz(2)],'-k');
plot3([v241(1)+dx(2) v242(1)+dx(2)],[v241(2)+dy(2) v242(2)+dy(2)],[v241(3)+dz(2) v242(3)+dz(2)],'-k');
plot3([v251(1)+dx(2) v252(1)+dx(2)],[v251(2)+dy(2) v252(2)+dy(2)],[v251(3)+dz(2) v252(3)+dz(2)],'-k');
plot3([v261(1)+dx(2) v262(1)+dx(2)],[v261(2)+dy(2) v262(2)+dy(2)],[v261(3)+dz(2) v262(3)+dz(2)],'-k');
...
plot3([v411(1)+dx(4) v412(1)+dx(4)],[v411(2)+dy(4) v412(2)+dy(4)],[v411(3)+dz(4) v412(3)+dz(4)],'-k');
plot3([v421(1)+dx(4) v422(1)+dx(4)],[v421(2)+dy(4) v422(2)+dy(4)],[v421(3)+dz(4) v422(3)+dz(4)],'-k');
plot3([v431(1)+dx(4) v432(1)+dx(4)],[v431(2)+dy(4) v432(2)+dy(4)],[v431(3)+dz(4) v432(3)+dz(4)],'-k');
plot3([v441(1)+dx(4) v442(1)+dx(4)],[v441(2)+dy(4) v442(2)+dy(4)],[v441(3)+dz(4) v442(3)+dz(4)],'-k');
plot3([v451(1)+dx(4) v452(1)+dx(4)],[v451(2)+dy(4) v452(2)+dy(4)],[v451(3)+dz(4) v452(3)+dz(4)],'-k');
plot3([v461(1)+dx(4) v462(1)+dx(4)],[v461(2)+dy(4) v462(2)+dy(4)],[v461(3)+dz(4) v462(3)+dz(4)],'-k');
...
plot3([v511(1)+dx(5) v512(1)+dx(5)],[v511(2)+dy(5) v512(2)+dy(5)],[v511(3)+dz(5) v512(3)+dz(5)],'-k');
plot3([v521(1)+dx(5) v522(1)+dx(5)],[v521(2)+dy(5) v522(2)+dy(5)],[v521(3)+dz(5) v522(3)+dz(5)],'-k');
plot3([v531(1)+dx(5) v532(1)+dx(5)],[v531(2)+dy(5) v532(2)+dy(5)],[v531(3)+dz(5) v532(3)+dz(5)],'-k');
plot3([v541(1)+dx(5) v542(1)+dx(5)],[v541(2)+dy(5) v542(2)+dy(5)],[v541(3)+dz(5) v542(3)+dz(5)],'-k');
plot3([v551(1)+dx(5) v552(1)+dx(5)],[v551(2)+dy(5) v552(2)+dy(5)],[v551(3)+dz(5) v552(3)+dz(5)],'-k');
plot3([v561(1)+dx(5) v562(1)+dx(5)],[v561(2)+dy(5) v562(2)+dy(5)],[v561(3)+dz(5) v562(3)+dz(5)],'-k');
 ...
 aw = [-1500 +5000 -5000 +1500 -11500 -5000]; axis(aw),axis square
 av = [135 20]; view(av)
 grid
