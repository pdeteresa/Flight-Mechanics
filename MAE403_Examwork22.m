...
%  s2s_id = surf(x2_s ,y2_s ,z2_s ); set(s2s_id ,'FaceAlpha',fa)
%  s3s_id = surf(x3_s ,y3_s ,z3_s ); set(s3s_id ,'FaceAlpha',fa)
%  s4s_id = surf(x4_s ,y4_s ,z4_s ); set(s4s_id ,'FaceAlpha',fa)
 s5s_id = surf(x5_s ,y5_s ,z5_s ); set(s5s_id ,'FaceAlpha',fa)
%  s6s_id = surf(x6_s ,y6_s ,z6_s ); set(s6s_id ,'FaceAlpha',fa)
%  s7s_id = surf(x7_s ,y7_s ,z7_s ); set(s7s_id ,'FaceAlpha',fa)
%  s8s_id = surf(x8_s ,y8_s ,z8_s ); set(s8s_id ,'FaceAlpha',fa)
 s9s_id = surf(x9_s ,y9_s ,z9_s ); set(s9s_id ,'FaceAlpha',fa)
%  s10s_id = surf(x10_s,y10_s,z10_s); set(s10s_id,'FaceAlpha',fa)
%  s11s_id = surf(x11_s,y11_s,z11_s); set(s11s_id,'FaceAlpha',fa)
%  s12s_id = surf(x12_s,y12_s,z12_s); set(s12s_id,'FaceAlpha',fa)
plot3(xv1_s ,yv1_s ,zv1_s ,'-k');
%  plot3(xv2_s ,yv2_s ,zv2_s ,'-k');
%  plot3(xv3_s ,yv3_s ,zv3_s ,'-k');
%  plot3(xv4_s ,yv4_s ,zv4_s ,'-k');
 plot3(xv5_s ,yv5_s ,zv5_s ,'-k');
%  plot3(xv6_s ,yv6_s ,zv6_s ,'-k');
%  plot3(xv7_s ,yv7_s ,zv7_s ,'-k');
%  plot3(xv8_s ,yv8_s ,zv8_s ,'-k');
 plot3(xv9_s ,yv9_s ,zv9_s ,'-k');
%  plot3(xv10_s,yv10_s,zv10_s,'-k');
%  plot3(xv11_s,yv11_s,zv11_s,'-k');
%  plot3(xv12_s,yv12_s,zv12_s,'-k');
 plot3(0,0,0,'*r');
...
%set(a2_id,'XDir','reverse')
 ...
 xlabel('x_b (ft)'), ylabel('y_b (ft)'), zlabel('z_b (ft)')
 text(11,0,0,'x','FontName','Times','Color','r')
 text(0,7,0,'y','FontName','Times','Color','r')
 text(0,0,7,'z','FontName','Times','Color','r')